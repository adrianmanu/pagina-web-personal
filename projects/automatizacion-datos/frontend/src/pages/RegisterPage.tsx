...
export function RegisterPage() {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Comienza a automatizar tus datos en minutos"
      footer={
        <p>
          ¿Ya tienes cuenta?{' '}
    ...
    >
      <form className="auth-form" onSubmit={handleSubmit} noValidate>
        ...
        <FormField
          ...
          name="fullName"
          placeholder="Adrian Ramos Acosta"
          value={fullName}
        ...
        <label className="auth-checkbox auth-checkbox--terms">
          ...
          />
          <span>
            Acepto los términos de uso y la política de privacidad de la plataforma
          </span>
        </label>
