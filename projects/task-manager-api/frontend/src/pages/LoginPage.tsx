...
export function LoginPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('remembered_email_taskflow');
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (remember) localStorage.setItem('remembered_email_taskflow', email);
      navigate('/dashboard');
    } catch {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Ingresa a tu tablero de tareas"
      footer={
        <p>
          ¿No tienes cuenta?{' '}
